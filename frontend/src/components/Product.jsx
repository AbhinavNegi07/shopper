...
import ProductImgOne from "../assets/images/products/product-1.jpg";
import ProductImgTwo from "../assets/images/featured/featured-1.jpg";
          ...
          <div className="row mb-5">
            ...
            <div className="col-md-7">
              ...
              <div className="price h3 py-3">
                $20.00{" "}
                <span className="text-decoration-line-through">$18.00</span>
              </div>
              <div>
                100% Original Products <br />
                Pay on delivery might be available <br />
                Easy 15 days returns and exchange
              </div>
              <div className="pt-3">
